...
- **Popup** — simulated global hotkey popup (Ctrl+Shift+A), floating overlay with blur backdrop
...
- `Ctrl+Shift+A` — open quick popup (simulated in browser; would be global in Tauri)
